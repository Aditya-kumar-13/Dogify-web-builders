    ...
    >
      <Flex justify="space-between" align="center">
        ...
        <HStack gap={6} display={{ base: "none", md: "flex" }}>
          <Text  cursor="pointer" _hover={{ opacity: 0.7 }}>Home</Text>
          <Text  cursor="pointer" _hover={{ opacity: 0.7 }}>About</Text>
          <Text  cursor="pointer" _hover={{ opacity: 0.7 }}>Services</Text>
          <Text  cursor="pointer" _hover={{ opacity: 0.7 }}>Contact</Text>
        </HStack>
